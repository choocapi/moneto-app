        ...
        <View style={styles.container}>
            ...
            <View style={styles.footer}>
              <Animated.View entering={FadeInDown.duration(1000).springify().damping(12)} style={{alignItems: 'center'}}>
                ...
                <Typo size={24} fontWeight={'800'}>Sổ Thu Chi Moneto</Typo>
              </Animated.View>

              <Animated.View entering={FadeInDown.duration(1000).delay(100).springify().damping(12)} style={{alignItems: 'center', gap: 2}}>
                <Typo color={colors.textLight}>Trải nghiệm niềm vui quản lý tài chính bằng</Typo>
                <Typo color={colors.textLight}>việc đăng ký trong lần đầu sử dụng</Typo>
              </Animated.View>

              <Animated.View entering={FadeInDown.duration(1000).delay(200).springify().damping(12)} style={styles.buttonContainer}>
                <Button onPress={() => router.push('/(auth)/register')}>
                  <Typo size={22} color={colors.neutral900} fontWeight={'600'}>Đăng ký</Typo>
                </Button>
              </Animated.View>
            </View>
        </View>
